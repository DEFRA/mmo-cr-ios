#!/usr/bin/env bash
#
# Converts Xcode code-coverage results (.xcresult) into the SonarQube/SonarQube Cloud
# "Generic Test Coverage" XML format, written to stdout.
#
# Usage:
#   scripts/xccov-to-sonarqube-generic.sh <path-to.xcresult> [<more.xcresult> ...] > sonar-coverage.xml
#
# Requires the Xcode command line tools (xcrun xccov), i.e. it runs on the macOS CI runner.
